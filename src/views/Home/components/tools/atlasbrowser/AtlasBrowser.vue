  ...
  <v-app class="main">
    ...
    <v-container fluid>
      <v-row>
        ...
        <v-col cols="12" sm="2" class="pl-6 pt-3" v-if="!checkSpatial" style="margin-top: 60px;">
          <!-- workflow menu -->
        ...
        <v-col cols="12" sm="9" v-if="!checkSpatial" style="margin-top: 60px;">
          <v-container>
...
export default defineComponent({
  name: 'AtlasBrowser',
  props: ['query'],
  components: { Selector, MetadataDropdown, Appbar, MainMenu },
  setup(props, ctx) {
